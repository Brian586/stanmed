    ...
    28930: (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) => {
        ...
        if (delete window.__PRELOADED_STATE__,
            ...
            da_pgLoadStarted && (window.appEventData = window.appEventData || [],
                ...
                "http:" == location.protocol && (location.href.startsWith("http://www.stanmed.global")) && (location.protocol = "https:")
        }
                ...
                (m = [{
                    ...
                    value: function () {
                        if (this.props.metainfo) {
                            ...
                            return e.canonical && !e.canonical.startsWith("http") && e.canonical.startsWith("/") && (t = ("epoc" == this.props.siteName ? "https://www.stanmed.global" : "https://www.stanmed.global") + t),
